...
|-----|------|---------|-------------|
| certificatePrehook | object | `{"image":{"pullPolicy":"IfNotPresent","registry":null,"repository":"stackstate/container-tools","tag":"1.8.2-bci-517"},"resources":{"limits":{"cpu":"100m","memory":"200Mi"},"requests":{"cpu":"100m","memory":"200Mi"}}}` | Helm prehook to setup/remove a certificate for the sidecarInjector mutationwebhook |
...
| certificatePrehook.image.tag | string | `"1.8.2-bci-517"` | The tag for the docker image |
...
| proxy | object | `{"image":{"pullPolicy":"IfNotPresent","registry":null,"repository":"stackstate/http-header-injector-proxy","tag":"4091544b-205"},"resources":{"limits":{"memory":"40Mi"},"requests":{"memory":"25Mi"}}}` | Proxy being injected into pods for rewriting http headers |
...
| proxy.image.tag | string | `"4091544b-205"` | The tag for the docker image |
...
| proxyInit | object | `{"image":{"pullPolicy":"IfNotPresent","registry":null,"repository":"stackstate/http-header-injector-proxy-init","tag":"4091544b-205"}}` | InitContainer within pod which redirects traffic to the proxy container. |
...
| proxyInit.image.tag | string | `"4091544b-205"` | The tag for the docker image |
| sidecarInjector | object | `{"image":{"pullPolicy":"IfNotPresent","registry":null,"repository":"stackstate/generic-sidecar-injector","tag":"d03e11f3-22"}}` | Service for injecting the proxy sidecar into pods |
...
| sidecarInjector.image.tag | string | `"d03e11f3-22"` | The tag for the docker image |
