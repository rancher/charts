...
Current chart version is `1.2.8`
...
| checksAgent.image.tag | string | `"289d9a9e"` | Default container image tag. |
...
| clusterAgent.image.tag | string | `"289d9a9e"` | Default container image tag. |
...
| nodeAgent.containers.agent.image.tag | string | `"289d9a9e"` | Default container image tag. |
