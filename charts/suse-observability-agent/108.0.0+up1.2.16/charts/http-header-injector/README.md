...
|-----|------|---------|-------------|
| certificatePrehook | object | `{"image":{"pullPolicy":"IfNotPresent","registry":null,"repository":"stackstate/container-tools","tag":"1.8.1-bci"},"resources":{"limits":{"cpu":"100m","memory":"200Mi"},"requests":{"cpu":"100m","memory":"200Mi"}}}` | Helm prehook to setup/remove a certificate for the sidecarInjector mutationwebhook |
...
| certificatePrehook.image.tag | string | `"1.8.1-bci"` | The tag for the docker image |
...
| proxy | object | `{"image":{"pullPolicy":"IfNotPresent","registry":null,"repository":"stackstate/http-header-injector-proxy","tag":"cb2eb8ab-194"},"resources":{"limits":{"memory":"40Mi"},"requests":{"memory":"25Mi"}}}` | Proxy being injected into pods for rewriting http headers |
...
| proxy.image.tag | string | `"cb2eb8ab-194"` | The tag for the docker image |
...
| proxyInit | object | `{"image":{"pullPolicy":"IfNotPresent","registry":null,"repository":"stackstate/http-header-injector-proxy-init","tag":"cb2eb8ab-194"}}` | InitContainer within pod which redirects traffic to the proxy container. |
...
| proxyInit.image.tag | string | `"cb2eb8ab-194"` | The tag for the docker image |
| sidecarInjector | object | `{"image":{"pullPolicy":"IfNotPresent","registry":null,"repository":"stackstate/generic-sidecar-injector","tag":"d03e11f3-21"}}` | Service for injecting the proxy sidecar into pods |
...
| sidecarInjector.image.tag | string | `"d03e11f3-21"` | The tag for the docker image |
