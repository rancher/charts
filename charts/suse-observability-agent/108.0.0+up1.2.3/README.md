...
| checksAgent.image.tag | string | `"de9360ab"` | Default container image tag. |
...
| clusterAgent.image.tag | string | `"de9360ab"` | Default container image tag. |
...
| nodeAgent.containers.agent.image.tag | string | `"de9360ab"` | Default container image tag. |
