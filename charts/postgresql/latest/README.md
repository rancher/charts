...
Rancher version of [heml chart](https://github.com/helm/charts/tree/master/stable/postgresql)

## Introduction

This chart bootstraps a [PostgreSQL](https://github.com/docker-library/postgres) deployment on a [Kubernetes](http://kubernetes.io) cluster.
...
| `imageTag`                 | `postgres` image tag                            | `10.5`                                                    |
...
| `persistence.resourcePolicy` | set resource-policy Helm annotation on PVC. Can be nil or "keep" | `keep`                                   |
