...
{{- define "project-prometheus-stack.prometheus.fullname" -}}
{{- printf "%s-prometheus" (include "project-prometheus-stack.fullname" .) -}}
{{- end }}

{{/* Fullname suffixed with alertmanager */}}
{{- define "project-prometheus-stack.alertmanager.fullname" -}}
{{- printf "%s-alertmanager" (include "project-prometheus-stack.fullname" .) -}}
{{- end }}
...
{{- if .Values.prometheus.serviceAccount.create -}}
    {{ default (include "project-prometheus-stack.prometheus.fullname" .) .Values.prometheus.serviceAccount.name }}
{{- else -}}
...
{{- if .Values.alertmanager.serviceAccount.create -}}
    {{ default (include "project-prometheus-stack.alertmanager.fullname" .) .Values.alertmanager.serviceAccount.name }}
{{- else -}}
