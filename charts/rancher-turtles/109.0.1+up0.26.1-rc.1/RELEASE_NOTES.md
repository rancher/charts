...
## Changes since v0.26.1-rc.0
## :chart_with_upwards_trend: Overview
- 105 new commits merged

:book: Additionally, there have been 2 contributions to our documentation and book. (#2108, #2306) 
...
- Build-and-release: Bump actions/create-github-app-token from 3.0.0 to 3.1.1 (#2294)
...
- Build-and-release: Bump actions/upload-artifact from 7.0.0 to 7.0.1 (#2291)
...
- Build-and-release: Bump updatecli/updatecli-action from 3.0.0 to 3.1.1 (#2292)
...
- Capi: Remove addon finalizer (#2308)
...
- Chart: Remove obsolete hook (#2301)
...
- Dependency: Bump golang.org/x/text from 0.35.0 to 0.36.0 in the other-dependencies group (#2293)
...
- Examples: Update docker-rke2 cluster example (#2290)
...
- Security: Bump go to 1.25.9 (#2298)
- Security: Bump go to v1.24.13 (#2057)
- Security: Check immutable checksum after curl download (#2296)
...
- golang.org/x/mod: v0.32.0 → v0.34.0
- golang.org/x/net: v0.51.0 → v0.52.0
- golang.org/x/sync: v0.19.0 → v0.20.0
- golang.org/x/sys: v0.41.0 → v0.42.0
- golang.org/x/telemetry: bd525da → 579e4da
