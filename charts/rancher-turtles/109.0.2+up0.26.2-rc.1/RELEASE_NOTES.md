...
## Changes since v0.26.2-rc.0
## :chart_with_upwards_trend: Overview
- 137 new commits merged
...
- Build-and-release: Bump aquasecurity/trivy-action from 0.35.0 to 0.36.0 (#2328)
...
- Build-and-release: Bump github/codeql-action from 4.35.1 to 4.35.2 (#2317)
- Build-and-release: Bump github/codeql-action from 4.35.2 to 4.35.3 (#2347)
- Build-and-release: Bump github/codeql-action from 4.35.3 to 4.35.4 (#2374)
- Build-and-release: Bump rancher/ecm-distro-tools to latest commit sha (#2376)
...
- Build-and-release: Bump rancherlabs/slsactl from 0.1.30 to 0.1.31 (#2327)
- Build-and-release: Bump rancherlabs/slsactl from 0.1.31 to 0.1.32 (#2377)
...
- Build-and-release: Bump sigstore/cosign-installer from 4.1.1 to 4.1.2 (#2375)
- Build-and-release: Bump slackapi/slack-github-action from 2.1.1 to 3.0.1 (#2215)
- Build-and-release: Bump slackapi/slack-github-action from 3.0.1 to 3.0.3 (#2346)
...
- Build-and-release: Bump updatecli/updatecli-action from 3.1.1 to 3.1.3 (#2332)
- Build-and-release: Use go generate for release against Rancher (#2369)
...
- Caprke2: Bump caprke2 to v0.24.4 (#2391)
...
- CI: Remove release notes from chart (#2341)
...
- Community: Add provisional AI policy (#2320)
- Dependency/Chart: Automatically update kuberlr-kubectl version (#2253)
- Dependency/Security: Bump github.com/go-git/go-git/v5 from 5.18.0 to 5.19.0 in /test (#2379)
- Dependency/Security: Bump go-git to v5.17.2 (#2280)
- Dependency: Bump CAPI operator to v0.27.0 (#2386)
...
- Dependency: Bump github.com/go-git/go-git/v5 from 5.17.2 to 5.18.0 in /test (#2316)
...
- Dependency: Bump golang.org/x/text from 0.36.0 to 0.37.0 in the other-dependencies group across 1 directory (#2373)
- Dependency: Bump the other-dependencies group in /test with 2 updates (#2118)
- Dependency: Bump the testing-dependencies group across 1 directory with 2 updates (#2345)
- Dependency: Bump the testing-dependencies group across 1 directory with 2 updates (#2348)
...
- Operator: Improve Image Pull Secret Support (#2335)
...
- Providers: Bump capa to v2.11.1 (#2366)
...
- Providers: Core provider is now under rancher/ org (#2361)
- Providers: Remove last reference to rancher-sandbox (#2381)
...
- Release: Describe dependency bump process on release branches (#2364)
- Release: Move provider charts version setting as pre-requisites in the doc (#2139)
- Release: Use publish image action in release workflow (#2354)
- Security: Add new release branch format to codeql (#2058)
- Security: Bump capi to v1.12.7 (#2383)
- Security: Bump go to 1.25.10 (#2382)
...
- Testing/Providers: Provision v1.35 eks clusters (#2371)
...
- Testing: Remove gitea subdomain from ngrok (#2358)
...
- Ux: Print feature gates status in setup logs (#2343)
...
- k8s.io/api: v0.34.5 → v0.34.7
- k8s.io/apiextensions-apiserver: v0.34.5 → v0.34.7
- k8s.io/apimachinery: v0.34.5 → v0.34.7
- k8s.io/apiserver: v0.34.5 → v0.34.7
- k8s.io/client-go: v0.34.5 → v0.34.7
- k8s.io/code-generator: v0.34.5 → v0.34.7
- k8s.io/component-base: v0.34.5 → v0.34.7
- k8s.io/kms: v0.34.5 → v0.34.7
- sigs.k8s.io/cluster-api-operator: v0.26.0 → v0.27.0
