...
## Changes since v0.25.0-rc.3
## :chart_with_upwards_trend: Overview
- 52 new commits merged
- 1 bug fixed 🐛
...
### Changed
- github.com/gkampitakis/go-snaps: [v0.5.14 → v0.5.15](https://github.com/gkampitakis/go-snaps/compare/v0.5.14...v0.5.15)
- github.com/onsi/ginkgo/v2: [v2.26.0 → v2.27.2](https://github.com/onsi/ginkgo/compare/v2.26.0...v2.27.2)
