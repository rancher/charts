...
## Changes since v0.25.4-rc.1
## :chart_with_upwards_trend: Overview
- 171 new commits merged
- 1 bug fixed 🐛
...
- Build-and-release: Chore(deps): Bump aquasecurity/trivy-action from 0.34.0 to 0.34.1 (#2148)
...
- Build-and-release: Release: verify chart asset is always present after release upload step (#2141)
...
- Dependency: Chore(deps): Bump github.com/caarlos0/env/v11 from 11.3.1 to 11.4.0 in /test in the other-dependencies group across 1 directory (#2150)
...
- Release: Doc: Move provider charts version setting as pre-requisites in the doc (#2139)
...
- Testing: Test: Moving providers secrets creation to after installation of the providers chart (#2147)
- Testing: Test: remove aso waiter (#2081)
- Testing: Test: remove capi bump test (#2083)
- Testing: Test: remove provider migration (#2127)
